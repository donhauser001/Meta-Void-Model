...
[![中文](https://img.shields.io/badge/中文-版本-blue)](README.md)
...
- [Core Formula →](../engine/mapping-logic/formula-S.en.md)
- [Formal Appendix →](../spec/formal-appendix.en.md)
- [Snapshot Mechanism →](../engine/snapshot-service/discrete-generation.en.md)
