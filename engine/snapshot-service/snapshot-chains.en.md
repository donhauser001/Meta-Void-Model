...
[![中文](https://img.shields.io/badge/中文-版本-blue)](snapshot-chains.md)
...
|-------------------|-------|
| Single snapshot generation mechanism | [→ discrete-generation.en.md](discrete-generation.en.md) |
| Complete generation formula S | [→ ../mapping-logic/formula-S.en.md](../mapping-logic/formula-S.en.md) |
