...
[![中文](https://img.shields.io/badge/中文-版本-blue)](integral-model.md)
...
graph TD
    ...
    subgraph Individual Layer
        C1[Snapshot Chain θ₁]
        C2[Snapshot Chain θ₂]
        Cm[Snapshot Chain θₘ]
    end

    subgraph Collective Layer
        TH[Integral Consciousness Θ]
        RHO[Snapshot Density Distribution ρₛ]
    end

    subgraph Macroscopic Layer
        R[Macroscopic Reality R]
    end
    ...
    PS[Non-existence Tension Structure] -.-> S1
    PS -.-> S2
    PS -.-> S3
    PS -.-> Sn
```
...
| Snapshot Chains and Causality | [→ ../snapshot-service/snapshot-chains.en.md](../snapshot-service/snapshot-chains.en.md) |
