...
[![中文](https://img.shields.io/badge/中文-版本-blue)](../zh/formal-appendix.md)
...
| ID | Axiom | Document Reference |
|----|-------|-------------------|
| S.1 | Reality consists of discrete snapshot sequences | [discrete-generation.md](../engine/snapshot-service/discrete-generation.md) |
| S.2 | O collapses potential state to determinate state | [discrete-generation.md](../engine/snapshot-service/discrete-generation.md) |
| S.4 | Time is sequence number difference of snapshot chain | [snapshot-chains.md](../engine/snapshot-service/snapshot-chains.md) |
| S.5 | Causality is structural coupling | [snapshot-chains.md](../engine/snapshot-service/snapshot-chains.md) |

### Formula Axioms (F.x)

| ID | Axiom | Document Reference |
|----|-------|-------------------|
| F.1 | ⊗ operator is non-linear | [formula-S.md](../engine/mapping-logic/formula-S.md) |
| F.2 | ⊗ has perturbation effect | [formula-S.md](../engine/mapping-logic/formula-S.md) |
